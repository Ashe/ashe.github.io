...
tags:
  - GameMaker
  - Game
image: https://res.cloudinary.com/aas-sh/image/upload/v1757615402/projects/street_fighter/streetfighter_preview-optimize_uadhen.gif
status: published
---
...
This project was made as part of a university assignment in November, 2019. Since GMS is proprietary software, I've taken the liberty of compiling the project into a `.exe` file that you can find [here](https://github.com/Ashe/Streetfighter/releases/). The point of this project was to try and mimic StreetFighter as closely as possible and understand not only *what* mechanics were programmed but also *why*.
...
:::{.figure
  image="https://res.cloudinary.com/aas-sh/image/upload/v1757614709/projects/street_fighter/opening_screen_vuq3cv.png"
