...
tags:
  - Haskell
  - Game
image: https://res.cloudinary.com/aas-sh/image/upload/v1757611805/projects/simple_roguelike_hs/simpleroguelikehs_lfaefs.gif
status: published
---

:::{.gitrepo header="SimpleRoguelike.hs"}
A link to the repository can be found [here](https://github.com/Ashe/SimpleRoguelike.hs).
:::
