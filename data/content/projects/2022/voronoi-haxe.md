...
tags:
  ...
  - Web
images:
  - https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/1.png?raw=true
  - https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/2.png?raw=true
  - https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/3.png?raw=true
  - https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/4.png?raw=true
status: published
---

:::{.live header="Live demo available"}
A live demo of this project can be found [here](https://aas.sh/Voronoi.haxe).
:::

:::{.gitrepo header="aas.sh"}
GitHub repository for this website can be found [here](https://github.com/Ashe/Voronoi.haxe).
:::
...
:::{.caption .w-full .h-full .hidden-on-mobile
  caption="The live demo of Voronoi.haxe, embedded into this page. It might not work as well as the [full-window version](https://aas.sh/Voronoi.haxe/)."
  source="Voronoi.haxe"
  sourceUrl="https://github.com/Ashe/Voronoi.haxe"
}
...
Next, I started to transform the grid into a voronoi pattern. In nature, voronoi patterns appear in things like bubbles, where a shape is 'inflated' until its boundaries collide with other boundaries. The trick is to select a point inside a shape and then 'inflate' from there. You can find all the code below [here](https://github.com/Ashe/Voronoi.haxe/blob/master/src/Hexgrid.hx).
...
:::{.caption
  caption="Samples of different terrain generated."
  source="Voronoi.haxe"
  sourceUrl="https://github.com/Ashe/Voronoi.haxe"
}
:::{.gallery-wall}
:::{.child}
![Preview 1](https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/1.png?raw=true)
![Preview 3](https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/3.png?raw=true)
:::
:::{.child}
![Preview 2](https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/2.png?raw=true)
![Preview 4](https://github.com/Ashe/Voronoi.haxe/blob/master/docs/preview/4.png?raw=true)
:::
:::
:::
